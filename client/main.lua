...
function overdose()
	Citizen.CreateThread(function()
		...
		ResetPedMovementClipset(playerPed, 0)
		SetPedMotionBlur(playerPed, false)
		--ESX.ShowNotification("Vous avez fait ~r~une overdose~s~...")
...
AddEventHandler('esx_optionalneeds:runMan', function()
	...
	--ESX.ShowNotification('Les effets commencent à se dissiper...')
...
AddEventHandler('esx_optionalneeds:useItemCoke', function()
	...
	local playerPed = PlayerPedId()
	--ESX.ShowNotification('Tu sens la drogue monter dans ton cerveau et faire son effet...')
